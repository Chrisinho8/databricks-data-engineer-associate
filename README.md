...
| File | What it is |
|------|------------|
| `Guide.pdf` | Full study guide covering all 7 domains and every subdomain: worked code, analogies, common traps, one-minute recaps, a master cheat sheet, and a bonus 45-question mock with answer key. |
